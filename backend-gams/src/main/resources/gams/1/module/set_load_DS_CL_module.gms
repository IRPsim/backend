...
EQUATIONS EqLoad_CL4_I(set_ii_0,set_pss) Summierung Lastreduktionen inklusive Regelenergievorhaltung Periodenanfang (erste Optimierungshaelfte);
EqLoad_CL4_I(set_ii,set_load_DS_CL)$(set_pss_opt(set_load_DS_CL) and par_X_pss_model(set_load_DS_CL)=1
                                         AND par_DSM_DS_CL_t(set_load_DS_CL)>0 AND par_DSM_DS_CL_Cup(set_load_DS_CL)>0
                                         AND (ORD(set_ii) ge sca_numberStoring*sca_iterator+1)
                                         AND (ORD(set_ii) le sca_numberStoring*(sca_iterator+1)))..
          sum(set_ii_duplicate$(ORD(set_ii_duplicate)>=sca_numberStoring*sca_iterator+1 AND ORD(set_ii_duplicate)>=ORD(set_ii)-(1/sca_delta_ii)*par_DSM_DS_CL_t(set_load_DS_CL)
...
EQUATIONS EqLoad_CL4_II(set_ii_0,set_pss) Summierung Lastreduktionen inklusive Regelenergievorhaltung Periodenanfang (zweite Optimierungshaelfte);
EqLoad_CL4_II(set_ii,set_load_DS_CL)$(set_pss_opt(set_load_DS_CL) and par_X_pss_model(set_load_DS_CL)=1
                                         AND par_DSM_DS_CL_t(set_load_DS_CL)>0 AND par_DSM_DS_CL_Cup(set_load_DS_CL)>0
                                         AND (ORD(set_ii) ge sca_numberStoring*(sca_iterator+1)+1)
                                         AND (ORD(set_ii) le sca_numberStoring*(sca_iterator+2)))..
          sum(set_ii_duplicate$(ORD(set_ii_duplicate)>=sca_numberStoring*sca_iterator+1+sca_numberStoring AND ORD(set_ii_duplicate)>=ORD(set_ii)-(1/sca_delta_ii)*par_DSM_DS_CL_t(set_load_DS_CL)
...
EQUATIONS EqLoad_CL5_I(set_ii_0,set_pss) Wiederherstellung Lastverschiebung Periodenanfang (erste Optimierungshaelfte);
EqLoad_CL5_I(set_ii,set_load_DS_CL)$(set_pss_opt(set_load_DS_CL) and par_X_pss_model(set_load_DS_CL)=1
                                         AND par_DSM_DS_CL_t(set_load_DS_CL)>0 AND par_DSM_DS_CL_Cup(set_load_DS_CL)>0
                                         AND (ORD(set_ii) ge sca_numberStoring*sca_iterator+1)
                                         AND (ORD(set_ii) le sca_numberStoring*(sca_iterator+1)))..
          var_DSM_up(set_ii,set_load_DS_CL)
...
EQUATIONS EqLoad_CL5_II(set_ii_0,set_pss) Wiederherstellung Lastverschiebung Periodenanfang (zweite Optimierungshaelfte);
EqLoad_CL5_II(set_ii,set_load_DS_CL)$(set_pss_opt(set_load_DS_CL) and par_X_pss_model(set_load_DS_CL)=1
                                         AND par_DSM_DS_CL_t(set_load_DS_CL)>0 AND par_DSM_DS_CL_Cup(set_load_DS_CL)>0
                                         AND (ORD(set_ii) ge sca_numberStoring*(sca_iterator+1)+1)
                                         AND (ORD(set_ii) le sca_numberStoring*(sca_iterator+2)))..
          var_DSM_up(set_ii,set_load_DS_CL)
...
*EqLoad_CL2a_I, EqLoad_CL2a_II, EqLoad_CL2m_I, EqLoad_CL2m_II, EqLoad_CL2e_I, EqLoad_CL2e_II,, EqLoad_CL4a_I, EqLoad_CL4a_II, EqLoad_CL4m_I, EqLoad_CL4m_II, EqLoad_CL4e_I, EqLoad_CL4e_II, EqLoad_CL5a_I, EqLoad_CL5a_II, EqLoad_CL5m_I, EqLoad_CL5m_II, EqLoad_CL5e_I, EqLoad_CL5e_II
model mod_load_DS_CL_orga /EqLoad_CL1, EqLoad_CL1_1, EqLoad_CL2_I, EqLoad_CL2_II, EqLoad_CL3, EqLoad_CL4_I, EqLoad_CL4_II, EqLoad_CL5_I, EqLoad_CL5_II, EqLoad_CL6/;
model mod_load_DS_CL_cust /EqLoad_CL1, EqLoad_CL1_1, EqLoad_CL2_I, EqLoad_CL2_II, EqLoad_CL3, EqLoad_CL4_I, EqLoad_CL4_II, EqLoad_CL5_I, EqLoad_CL5_II, EqLoad_CL6/;
